...
contract CSPDTokenVesting is Context, Ownable {
    ...
    uint256 public initialTotalAmount = 100000000 ether;
    ...
    function initialData() private {
        // add members & their addresses as following example
        members.push(address(0x0C25363022587299510774E036ad078682991256));


        // add schedule time as following example
        vestingTimeList.push(1635526800); // 2021-12-10


        // add schedule time in string as following example
        ...
        // for 2021-12-10
        vestingTimeScheduleList[vestingTimeList[0]][members[0]] = addVestingSchedule(12345 ether);


        // for other months until 2022-06
        for (uint256 j = 1; j < 7; j++) {
            vestingTimeScheduleList[vestingTimeList[j]][members[0]] = addVestingSchedule(237500 ether);

        }

        // smart contract address if members have different amounts to be unlocked after time 

        // 2021-12-10
        vestingTimeScheduleList[vestingTimeList[0]][members[9]] = addVestingSchedule(2650000 ether);
  

        // 2022-01-10 and 2022-02-10
    ...
    function unlockToken() external onlyAdmin {
        ...
        if (releasedVestingId == 0) {
            require(_token.balanceOf(address(this)) >= initialTotalAmount, "You need to deposit the Private sale tokens into this contract before you start this contract.");
        }
